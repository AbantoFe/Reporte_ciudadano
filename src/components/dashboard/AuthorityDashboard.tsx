        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="font-semibold">{incident.profiles.full_name}</p>
              <p className="text-sm text-gray-600">{incident.profiles.email}</p>
              {incident.profiles.phone && (
                <p className="text-sm text-gray-600">{incident.profiles.phone}</p>
              )}
            </div>
